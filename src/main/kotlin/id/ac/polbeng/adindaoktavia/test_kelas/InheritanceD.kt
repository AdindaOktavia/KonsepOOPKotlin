...
class SoftwareEngineer : EmployeeD() { // Perbaiki penulisan nama kelas
    override val baseSalary: Int = 6000000
}

class ProjectManager : EmployeeD() { // Perbaiki penulisan nama kelas
    override val baseSalary: Int = 8000000
}

fun toRupiahFormat(baseSalary: Int): String {
    val localeID = Locale("in", "ID")
    val numberFormat = NumberFormat.getNumberInstance(localeID) // Perbaiki kesalahan penulisan
